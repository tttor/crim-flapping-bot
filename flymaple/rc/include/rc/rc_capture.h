...
volatile uint16_t chanPPM[8];
volatile uint16_t chanBegin[8];
volatile uint16_t chanEnd[8];
...
class RC_Capture {
  ...
  */
  ...
  /**
    @brief
  */
  uint16_t readRC(uint8_t channel);
...
uint16_t RC_Capture::readRC(uint8_t channel)
{
