...
#define THROTTLE_SIGNAL_IN 2 // INTERRUPT 0 = DIGITAL PIN 2 - use the interrupt number in attachInterrupt
#define THROTTLE_SIGNAL_IN_PIN 21 // INTERRUPT 0 = DIGITAL PIN 2 - use the PIN number in digitalRead
